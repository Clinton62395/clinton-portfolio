...
function Home() {
  ...
  return (
    <>
        ...
        <div className="container bi-relative bi-z-10 ">
          <div className="row align-items-center justify-centent-center mx-auto ">
            ...
            <div className="col-block col-md-7 text-center text-md-start text-white px-4 mb-5 ">
              ...
              <span className="bi-absolute bi-ml-60 mb-5 ">
                {" "}
                <TypingText />
              </span>
            </div>
      ...
      <section
        className=" bi-w-full bi-d-flex bi-items-centr bi-justify-center  text-white py-5 mt-5 bi-mb-24 text-center rounded shadow-lg shadow-blue bi-backdrop-blur p-5  bi-bg-gradient-to-r bi-from-teal-500/50 bi-via-dark bi-to-purple-500/50 bi-mx-auto"
        id="cv"
        data-aos="fade-up"
      >
        ...
        <a
          ...
          className="btn btn-primary btn-lg d-flex align-items-center justify-content-center hover:bi-animate-pulse"
          data-aos="zoom-in"
          data-aos-delay="400"
          style={{ width: "250px", margin: "auto" }}
        >
          <BiDownload className=" bi-text-white bi-text-3xl hvr-shadow" />
          Télécharger le CV
        </a>
      </section>
    </>
